//------------------------------------------------------------------------------
// <copyright file="SelfSignedCertificate.cs" company="Microsoft">
...
namespace CertLeakTest
{
    ...
    /// </summary>
    internal class SelfSignedCertificateHelper
    {
        public static X509Certificate2 CreateSelfSignX509CertificatePfx(string x500, DateTime startTime, DateTime endTime, string insecurePassword)
        {
            var pfxData = CreateSelfSignCertificatePfx(x500, startTime, endTime, insecurePassword);
            var cert = new X509Certificate2(pfxData, insecurePassword, X509KeyStorageFlags.Exportable);
            return cert;
        }
        ...
        public static byte[] CreateSelfSignCertificatePfx(string x500, DateTime startTime, DateTime endTime, SecureString password)
        {
            ...
            try
            {
                ...
                int cryptGenKeyFlags =
                    0x08000000 | // use 2048-bit rSA key (source: https://msdn.microsoft.com/en-us/library/windows/desktop/aa379941(v=vs.85).aspx)
                    1;           // CRYPT_EXPORTABLE
                ...
                // 1.2.840.113549.1.1.11 = szOID_RSA_SHA256RSA (source: https://msdn.microsoft.com/en-us/library/windows/desktop/aa381133(v=vs.85).aspx)
                CryptAlgorithmIdentifier algorithm = new CryptAlgorithmIdentifier { pszObjId = "1.2.840.113549.1.1.11", Parameters = new CryptoApiBlob() };
